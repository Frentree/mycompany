...
class AttendanceFirestoreRepository {
  ...
  Future<void> updateOvertime({required String companyId, required String attendanceUserMail, required Timestamp attendanceDate, required int overtime}) => _attendanceFirestoreCrud.updateOvertime(companyId: companyId, attendanceUserMail: attendanceUserMail, attendanceDate: attendanceDate, overtime: overtime);
}
