...
class _MonthViewRenderObject extends CustomCalendarRenderObject {
  ...
  TextStyle? get todayTextStyle => TextStyle(
      fontSize: 11.sp,
      color: whiteColor,
      fontFamily: 'Roboto'
  );
  ...
  static const double linePadding = 0.2;
  ...
  void _drawMonthCells(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < visibleDatesCount; i++) {
      ...
      if (currentVisibleDate.month == nextMonth) {
        ...
        textStyle = TextStyle(
            fontSize: 11.sp,
            color: currentVisibleDate.weekday == 7 ? Colors.red : currentVisibleDate.weekday == 6 ? Colors.blue : Colors.black87,
            fontFamily: 'Roboto'
        );
