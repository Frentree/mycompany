...
class MonthAppointmentHelper {
  ...
  static int getDateIndex(DateTime date, List<DateTime> visibleDates) {
    ...
    final dynamic modifiedEndDateTime = addDays(dateTime, 6);
    late final DateTime endDateTime;
    if (modifiedEndDateTime is DateTime) {
      endDateTime = modifiedEndDateTime;
    }
    ...
    dateTime.isBefore(endDateTime) || isSameDate(dateTime, endDateTime)) {
      ...
      currentViewIndex++;
      final dynamic addedDate = addDays(dateTime, 1);
