...
import 'package:mycompany/schedule/widget/date_time_picker/time_picker_widget.dart';
...
class _DatePickerComponent extends StatelessWidget {
  ...
  _DatePickerComponent({Key? key, @required required this.route, @required pickerHeight})
