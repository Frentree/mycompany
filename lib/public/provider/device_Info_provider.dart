...
class DeviceInfoProvider with ChangeNotifier {
  ...
  void setDeviceInfoData({Map<String, dynamic>? deviceInfoData}) {
    _deviceInfoData = deviceInfoData!;
    notifyListeners();
  }

  void setDeviceId({Map<String, dynamic>? deviceInfo}) {
  ...
  Future<void> readDeviceInfoData() async {
    ...
    setDeviceInfoData(deviceInfoData: deviceData);
    setDeviceId(deviceInfo: deviceData);
  }
}
