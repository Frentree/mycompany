...
class LoginFirestoreRepository {
  ...
  Future<EmployeeModel> readEmployeeData({required String companyId, required String email}) => _loginFirebaseCrud.readEmployeeData(companyId: companyId, email: email);
  ...
  //Company 관련
  Future<void> createCompanyData({required CompanyModel companyModel}) => _loginFirebaseCrud.createCompanyData(companyModel: companyModel);
  Future<List<CompanyModel>> readAllCompanyData() => _loginFirebaseCrud.readAllCompanyData();
}
