...
class ExpenseRegistrationUpdateView extends StatefulWidget {
  final ExpenseModel model;

  ExpenseRegistrationUpdateView({required this.model});

  @override
  _ExpenseRegistrationUpdateViewState createState() => _ExpenseRegistrationUpdateViewState();
}

class _ExpenseRegistrationUpdateViewState extends State<ExpenseRegistrationUpdateView> {
  ...
  void initState() {
    ...
    seleteTime = ValueNotifier(widget.model.buyDate.toDate());
    uploadImageUrl = widget.model.imageUrl;
    seleteItem = widget.model.contentType;
    contentController.text = widget.model.detailNote ?? "";
    priceController.text = widget.model.cost.toString();
  }
                                                  ...
                                                  builder: (BuildContext context, String? pickImagePath, Widget? child) {
                                                    return InkWell(
                                                        ...
                                                        child: (pickImagePath == null)
                                                            ? getExpenseImage(size: 50, ImageUri: uploadImageUrl
