                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      onTap: () async {
                        ...
                        var result = await NoticeMethod().updateNoticeMethod(companyCode: loginUser!.companyCode!, title: titleController.text, content: noteController.text, nowModel: widget.model);
