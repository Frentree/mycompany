...
Future<bool> addTeamUserDialog(BuildContext context, TeamModel model, List<EmployeeModel> employeeList, List<EmployeeModel> list) async {
  ...
  list.map((data) =>
    getUserList.remove(data)
  ).toList();


  await loginDialogWidget(
      context: context,
      message: "team_menu_2".tr(),
      actions: [
        Expanded(
          child: Column(
            children: [
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    getProfileImage(size: 36, ImageUri: getUserList[index].profilePhoto.toString(),),
                                    SizedBox(width: 6.0.w,),
                                    Column(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(getUserList[index].name,
                                          style: getNotoSantBold(fontSize: 14.0, color: textColor),
                                        ),
                                        Text(getUserList[index].position! + " / " + getUserList[index].team!,
...
Future<bool> updateTeamNameDialog(BuildContext context, TeamModel model, TextEditingController teamNameContoller, List<EmployeeModel> list) async {
  ...
  await loginDialogWidget(
      context: context,
      message: "team_setting_dialog_5".tr(),
      actions: [
        Expanded(
          child: Column(
            children: [
...
Future<bool> deleteTeamDialog(BuildContext context, TeamModel model, List<EmployeeModel> list) async {
  ...
  await loginDialogWidget(
      context: context,
      message: "team_setting_dialog_3".tr(),
      actions: [
        confirmElevatedButton(
            topPadding: 81.0.h,
            buttonName: "dialogConfirm".tr(),
...
Future<bool> updatePositionNameDialog(BuildContext context, PositionModel model, TextEditingController positionNameContoller, List<EmployeeModel> list) async {
  bool result = false;
  positionNameContoller.text = model.position;
  await loginDialogWidget(
      context: context,
      message: "position_setting_dialog_5".tr(),
      actions: [
        Expanded(
          child: Column(
            children: [
...
Future<bool> deletePositionDialog(BuildContext context, PositionModel model, List<EmployeeModel> list) async {
  ...
  await loginDialogWidget(
      context: context,
      message: "position_setting_dialog_3".tr(),
      actions: [
        confirmElevatedButton(
            topPadding: 81.0.h,
            buttonName: "dialogConfirm".tr(),
